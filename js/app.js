$(document).ready(function() {
  ...
  buttonSearch.on('click', function() {
    ...
    // console.log(url);
    $.getJSON('//www.omdbapi.com/?s=' + inputMovie + '&apikey=cde77cc6').then(function(response) {
      ...
      $('#peliculas div img').on('click', function() {
        ...
        alert(dataIdMovie);
        $.getJSON('//www.omdbapi.com/?i=' + dataIdMovie + '&page=2&apikey=cde77cc6').then(function(response) {
